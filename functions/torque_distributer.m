...
%torque left
if(left_force <=0)
%     torque_left=[-100 -5]*[left_joint_pos-left_joint_pos_ref;left_joint_vel-left_joint_vel_ref];
    torque_left=0;
else
...
if(right_force <=0)
%     torque_right=[-100 -5]*[right_joint_pos-right_joint_pos_ref; right_joint_vel-right_joint_vel_ref];
    torque_right=0;
else
